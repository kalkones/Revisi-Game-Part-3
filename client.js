...
const Game = {
    ...
    createItem: (type, top, left, duration, speed) => {
        ...
        // Ronde 1-2 = diam (speed 0)
        // Ronde 3   = pelan (1.2)
        // Ronde 4   = kencang (2.4)
        // Ronde 5   = sangat kencang (3.8)
        const round = AppState.currentRound;
        const speedMap = { 1: 0, 2: 0, 3: 1.2, 4: 2.4, 5: 3.8 };
        const moveSpeed = speedMap[round] !== undefined ? speedMap[round] : 3.8;
